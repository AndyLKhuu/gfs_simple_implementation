...
type ChunkServerClient interface {
	...
	// Delete a chunk
	RemoveChunk(ctx context.Context, in *ChunkHandle, opts ...grpc.CallOption) (*Ack, error)
...
func (c *chunkServerClient) PrimaryCommitMutate(ctx context.Context, in *PrimaryCommitMutateRequest, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
func (c *chunkServerClient) CreateNewChunk(ctx context.Context, in *ChunkHandle, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
func (c *chunkServerClient) RemoveChunk(ctx context.Context, in *ChunkHandle, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
	err := c.cc.Invoke(ctx, "/protos.ChunkServer/RemoveChunk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChunkServerServer interface {
	...
	// Delete a chunk
	RemoveChunk(context.Context, *ChunkHandle) (*Ack, error)
	// Receive a lease for a chunk
...
func (UnimplementedChunkServerServer) RemoveChunk(context.Context, *ChunkHandle) (*Ack, error) {
...
func _ChunkServer_PrimaryCommitMutate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PrimaryCommitMutateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChunkServerServer).PrimaryCommitMutate(ctx, req.(*PrimaryCommitMutateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChunkServer_CreateNewChunk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChunkServerServer).CreateNewChunk(ctx, req.(*ChunkHandle))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChunkServer_RemoveChunk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChunkHandle)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChunkServerServer).RemoveChunk(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.ChunkServer/RemoveChunk",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChunkServerServer).RemoveChunk(ctx, req.(*ChunkHandle))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChunkServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChunkServer_RemoveChunk_Handler,
		},
		{
